    ...
    return (
        <>
            ...
            <div className={styles.descripcion}>
                <h3 className={styles.h3}>Cristóbal Bravo y Luz Marina Angarita de Bravo</h3>
